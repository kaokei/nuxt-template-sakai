...
<template>
  <PrimeFluid class="grid grid-cols-12 gap-8">
    <div class="col-span-12 xl:col-span-6">
      <div class="card">
        <div class="mb-4 text-xl font-semibold">Linear</div>
        <PrimeChart type="line" :data="lineData" :options="lineOptions"></PrimeChart>
      </div>
    </div>
    <div class="col-span-12 xl:col-span-6">
      <div class="card">
        <div class="mb-4 text-xl font-semibold">Bar</div>
        <PrimeChart type="bar" :data="barData" :options="barOptions"></PrimeChart>
      </div>
    </div>
    <div class="col-span-12 xl:col-span-6">
      <div class="card flex flex-col items-center">
        <div class="mb-4 text-xl font-semibold">Pie</div>
        <PrimeChart type="pie" :data="pieData" :options="pieOptions"></PrimeChart>
      </div>
    </div>
    <div class="col-span-12 xl:col-span-6">
      <div class="card flex flex-col items-center">
        <div class="mb-4 text-xl font-semibold">Doughnut</div>
        <PrimeChart type="doughnut" :data="pieData" :options="pieOptions"></PrimeChart>
      </div>
    </div>
    <div class="col-span-12 xl:col-span-6">
      <div class="card flex flex-col items-center">
    ...
    <div class="col-span-12 xl:col-span-6">
      <div class="card flex flex-col items-center">
        ...
        <PrimeChart type="radar" :data="radarData" :options="radarOptions"></PrimeChart>
      </div>
    </div>
  </PrimeFluid>
</template>
