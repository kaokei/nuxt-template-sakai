    ...
    <div class="md:w-1/2">
      <div class="card">
        ...
        >
          ...
          <template #footer>
            <PrimeButton label="Save" @click="close" />
          </template>
        </PrimeDialog>
        <PrimeButton label="Show" style="width: auto" @click="open" />
      </div>

      <div class="card">
        <div class="mb-4 text-xl font-semibold">Popover</div>
        <div class="flex flex-wrap gap-2">
          <PrimeButton type="button" label="Show" @click="toggleDataTable" />
          <PrimePopover ref="op" id="overlay_panel" style="width: 450px">
            <PrimeDataTable
      ...
      <div class="card">
        ...
        <div class="inline-flex gap-4">
          ...
          />
          <PrimeButton type="button" label="Save" v-tooltip="'Click to proceed'" />
        </div>
      </div>
    </div>
    <div class="md:w-1/2">
      <div class="card">
        ...
        <PrimeDrawer v-model:visible="visibleLeft" header="Drawer">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
        ...
        <PrimeDrawer v-model:visible="visibleRight" header="Drawer" position="right">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
        ...
        <PrimeDrawer v-model:visible="visibleTop" header="Drawer" position="top">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
        ...
        <PrimeDrawer v-model:visible="visibleFull" header="Drawer" position="full">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
        ...
        <PrimeButton
          ...
          style="margin-right: 0.25em"
        />
        <PrimeButton icon="pi pi-external-link" @click="visibleFull = true" />
      </div>
