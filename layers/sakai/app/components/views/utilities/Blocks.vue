<script setup>
import BlockViewer from '@sakai/components/BlockViewer.vue';
...
<template>
  <div>
    <!-- Page Hero Section -->
    <div
      class="mb-8 flex h-[440px] rounded-xl border bg-surface-0 bg-[url('/demo/images/blocks/landing-blocks.jpg')] bg-cover bg-no-repeat p-8 border-surface dark:bg-surface-900 dark:bg-[url('/demo/images/blocks/landing-blocks-dark.jpg')]"
    >
      <div
        class="sm:max-w-144 flex flex-col items-center justify-center gap-4 sm:items-start"
      >
        <span
          class="rounded-md bg-surface-950 px-2 py-1 text-sm font-bold text-white"
          >TailwindCSS v4</span
        >
        <div class="flex items-center gap-4">
          <span class="text-4xl font-bold text-surface-950 dark:text-surface-0"
            >PrimeBlocks</span
          >
        </div>
        <p
          class="text-center text-lg text-surface-700 sm:text-start dark:text-surface-300"
        >
          Ready-to-use UI blocks for building beautiful applications. A
          comprehensive collection of components designed to speed up your
          development process.
        </p>
    ...
    <BlockViewer header="Hero" :code="blocksCode.hero" free>
      <div
        class="min-h-160 relative flex flex-col bg-surface-0 lg:min-h-0 lg:flex-row dark:bg-surface-900"
      >
        <div
          class="flex h-full flex-1 flex-col justify-center md:justify-normal lg:flex lg:flex-row"
        >
          <div class="relative z-20 flex flex-1 items-center justify-center">
            <div class="flex h-full items-center justify-center">
              <div
                class="w-full max-w-2xl px-6 py-12 text-center lg:p-12 lg:text-left xl:p-16"
              >
                <h1
                  class="leading-tight! mb-6 text-4xl font-bold text-surface-0 lg:text-surface-900 xl:text-5xl dark:text-surface-0"
                >
                  <span class="block">Create the screens your</span>
                ...
                <p
                  class="mb-8 max-w-xl text-xl leading-normal text-surface-0/90 lg:max-w-none lg:text-surface-700 dark:text-surface-200"
                >
                ...
                >
                  <PrimeButton label="Learn More" type="button" />
                  <PrimeButton label="Live Demo" type="button" outlined />
                </div>
              </div>
            </div>
          </div>

          <div class="absolute inset-0 flex-1 lg:relative lg:inset-auto">
            <div
              class="absolute inset-0 z-10 bg-surface-900/60 lg:hidden dark:bg-surface-900/80"
            />
            <img
              src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/hero/hero-1.png"
              alt="hero-1"
    ...
    <BlockViewer header="Feature" :code="blocksCode.feature" free>
      <div
        class="bg-surface-0 px-6 py-20 text-center md:px-12 lg:px-20 dark:bg-surface-950"
      >
        <div class="flex flex-col gap-6">
          <div class="flex flex-col items-center gap-4">
            ...
            <div class="leading-tight text-surface-500 dark:text-surface-400">
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div class="w-full rounded-md p-4">
              <span
                class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-lg bg-surface-0 shadow dark:bg-surface-800"
              >
                <i
              ...
              <div class="flex flex-col gap-1">
                <div
                  class="text-xl font-medium leading-tight text-surface-900 dark:text-surface-0"
                >
                  Built for Developers
                </div>
                <p
                  class="leading-normal text-surface-500 dark:text-surface-400"
                >
            ...
            <div class="w-full rounded-md p-4">
              ...
              <div class="flex flex-col gap-1">
                ...
                <p
                  class="leading-normal text-surface-500 dark:text-surface-400"
                >
                  Nec tincidunt praesent semper feugiat. Sed adipiscing diam
            ...
            <div class="w-full rounded-md p-4">
              ...
              <div class="flex flex-col gap-1">
                ...
                <p
                  class="leading-normal text-surface-500 dark:text-surface-400"
                >
                  Mattis rhoncus urna neque viverra justo nec ultrices. Id
    ...
    <BlockViewer header="Card" :code="blocksCode.glass" free>
      <div
        class="bg-cover! bg-center! bg-no-repeat! flex items-center justify-center px-6 py-20 backdrop-blur-3xl md:px-20 lg:px-80"
        style="
        ...
        >
          <div class="flex w-full flex-col items-center gap-4">
            ...
            <div class="flex w-full flex-col gap-2">
              <div
                class="text-center text-3xl font-medium leading-tight text-white"
              >
                Welcome Back
              </div>
              <div class="text-center">
                <span class="text-white/80">Don't have an account? </span>
                <a
                  class="cursor-pointer text-white/80 underline hover:text-white/90"
                  >Sign up</a
                >
              </div>
            </div>
          ...
          <div class="flex w-full flex-col items-center gap-8">
            <div class="flex w-full flex-col gap-6">
              <PrimeIconField>
                <PrimeInputIcon class="pi pi-user text-white/70!" />
                <PrimeInputText
                  type="text"
                  class="appearance-none! border! border-white/10! w-full! outline-0! bg-white/10! text-white! placeholder:text-white/70! rounded-3xl! shadow-sm!"
              ...
              <PrimeIconField>
                <PrimeInputIcon class="pi pi-lock text-white/70!" />
                <PrimeInputText
                  type="password"
                  class="appearance-none! border! border-white/10! w-full! outline-0! bg-white/10! text-white! placeholder:text-white/70! rounded-3xl! shadow-sm!"
                  placeholder="Password"
          ...
          <a class="cursor-pointer text-white/80 hover:text-white/90"
            >Forgot Password?</a
          >
        </div>
      </div>
    ...
    <BlockViewer header="Pricing" :code="blocksCode.pricing" free>
      <div
        class="bg-surface-50 px-6 py-20 md:px-12 lg:px-20 dark:bg-surface-950"
      >
        <div class="mb-12 flex flex-col items-center justify-center gap-4">
          <div
            class="text-center text-4xl font-bold leading-tight text-surface-900 lg:text-5xl dark:text-surface-0"
          >
            Pricing Plans
          </div>
          <div
            class="text-center text-lg leading-normal text-surface-500 dark:text-surface-400"
          >
        ...
        <div class="mx-auto flex max-w-7xl flex-col gap-8 lg:flex-row">
          <div
            class="flex w-full flex-1 flex-col gap-6 rounded-2xl bg-surface-0 p-8 shadow-sm dark:bg-surface-800"
          >
            <div class="flex flex-col gap-2">
              <h4
                class="text-xl font-medium leading-tight text-surface-900 dark:text-surface-0"
              ...
              <p class="leading-normal text-surface-500 dark:text-surface-400">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit
                numquam eligendi quos.
              </p>
            </div>

            <div class="h-px w-full bg-surface-200 dark:bg-surface-700" />
            <div class="flex items-center gap-2">
              <span
                class="text-3xl font-bold leading-tight text-surface-900 dark:text-surface-0"
                >$9</span
              >
              <span
                class="font-medium leading-tight text-surface-500 dark:text-surface-400"
                >per month</span
              >
            </div>
            <div class="h-px w-full bg-surface-200 dark:bg-surface-600" />
            <ul class="flex flex-1 list-none flex-col gap-4">
              <li class="flex items-center gap-2">
                <i class="pi pi-check-circle text-lg! text-green-500" />
                <span
                  class="leading-tight text-surface-800 dark:text-surface-100"
                >
            ...
            <PrimeButton label="Buy Now" rounded class="w-full" />
          </div>
          <div
            class="flex w-full flex-1 flex-col gap-6 rounded-2xl bg-surface-0 p-8 shadow-sm dark:bg-surface-800"
          >
    ...
    <BlockViewer header="Call to Action" :code="blocksCode.cta" free>
      <div
        class="bg-surface-0 px-6 py-20 md:px-12 lg:px-20 dark:bg-surface-950"
      >
        <div
          class="flex flex-col items-center gap-4 text-center text-surface-700 dark:text-surface-100"
        >
          <div class="text-lg font-bold leading-tight text-primary">
            <i class="pi pi-discord text-lg! leading-none!" />&nbsp;POWERED BY
            DISCORD
          </div>
          <div
            class="text-4xl font-bold leading-tight text-surface-900 dark:text-surface-0"
          >
            Join our design community
          </div>
          <div
            class="text-xl leading-normal text-surface-700 dark:text-surface-100"
          >
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit
            numquam eligendi quos.
          </div>
          <PrimeButton label="Join Now" icon="pi pi-discord" rounded class="mt-4" />
        </div>
      </div>
    </BlockViewer>
    ...
    <BlockViewer
      ...
      free
    >
      <div class="bg-surface-0 pb-20 dark:bg-surface-950">
        <div
          class="flex flex-wrap items-center justify-between bg-surface-900 px-6 py-4 text-surface-100 lg:px-20"
        >
          <div class="font-bold">🔥 Hot Deals!</div>
          <div class="inline-flex items-center gap-1">
            <span class="hidden leading-normal lg:flex"
              ...
              odit.</span
            >
            <a class="font-bold text-surface-0 underline" href="#"
              >Learn More</a
            >
          </div>
          <PrimeButton
    ...
    <BlockViewer header="Page Heading" :code="blocksCode['page-heading']" free>
      <div class="bg-surface-0 px-6 py-8 md:px-12 lg:px-20 dark:bg-surface-950">
        <ul class="m-0 mb-5 flex list-none items-center p-0 font-medium">
          <li>
            <a
          ...
          <li class="px-2">
            <i
              class="pi pi-angle-right text-sm! leading-normal! text-surface-500 dark:text-surface-300"
            />
          </li>
          <li>
        ...
        <div class="flex flex-col items-start md:flex-row md:justify-between">
          <div>
            <div
              class="mb-4 text-3xl font-bold text-surface-900 dark:text-surface-0"
            >
              Customers
            </div>
            <div
              class="flex flex-wrap items-center gap-8 text-surface-700 dark:text-surface-300"
            >
              <div class="flex items-center gap-2">
                <i class="pi pi-users text-base! leading-normal!" />
                <span>332 Active Users</span>
          ...
          <div class="mt-6 flex items-center md:mt-0">
            <PrimeButton label="Add" class="mr-3" outlined icon="pi pi-user-plus" />
            <PrimeButton
              label="Save Changes"
              icon="pi pi-check"
    ...
    <BlockViewer header="Stats" :code="blocksCode.stats" free>
      <div
        class="bg-surface-50 px-6 py-8 md:px-12 lg:px-20 dark:bg-surface-950"
      >
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div
            class="rounded-2xl bg-surface-0 p-5 shadow-sm dark:bg-surface-900"
          >
            <div class="flex justify-between gap-4">
              <div class="flex flex-col gap-2">
                <span
                  class="font-normal leading-tight text-surface-700 dark:text-surface-300"
                  >Messages</span
                >
                <div
              ...
              <div
                class="bg-linear-to-b flex h-10 w-10 items-center justify-center rounded-lg from-cyan-400 to-cyan-600 dark:from-cyan-300 dark:to-cyan-500"
              >
                <i
                  class="pi pi-envelope text-xl! leading-none! text-surface-0 dark:text-surface-900"
                />
              </div>
            </div>
            <div class="mt-4">
              <span
                class="font-medium leading-tight text-surface-600 dark:text-surface-300"
                >24 new</span
              >
              <span
                class="leading-tight text-surface-500 dark:text-surface-300"
              >
          ...
          >
            <div class="flex justify-between gap-4">
              ...
              <div
                class="bg-linear-to-b flex h-10 w-10 items-center justify-center rounded-lg from-orange-400 to-orange-600 dark:from-orange-300 dark:to-orange-500"
              >
                <i
                  class="pi pi-map-marker text-xl! leading-none! text-surface-0 dark:text-surface-900"
                />
              </div>
            </div>
            <div class="mt-4">
          ...
          >
            <div class="flex justify-between gap-4">
              ...
              <div
                class="bg-linear-to-b flex h-10 w-10 items-center justify-center rounded-lg from-slate-400 to-slate-600 dark:from-slate-300 dark:to-slate-500"
              >
                <i
                  class="pi pi-file text-xl! leading-none! text-surface-0 dark:text-surface-900"
                />
              </div>
            </div>
            <div class="mt-4">
              <span class="leading-tight text-surface-500 dark:text-surface-300"
                >32,56 / 250 GB</span
              >
            </div>
          </div>
          ...
          >
            <div class="flex justify-between gap-4">
              ...
              <div
                class="bg-linear-to-b flex h-10 w-10 items-center justify-center rounded-lg from-violet-400 to-violet-600 dark:from-violet-300 dark:to-violet-500"
              >
                <i
                  class="pi pi-users text-xl! leading-none! text-surface-0 dark:text-surface-900"
                />
              </div>
            </div>
            <div class="mt-4">
    ...
    >
      <div
        class="flex items-center justify-center bg-surface-50 px-6 py-20 md:px-12 lg:px-20 dark:bg-surface-950"
      >
        <div
        ...
        >
          <div class="flex flex-col items-center gap-4">
            ...
            <div class="flex w-full flex-col items-center gap-2">
              <div
                class="w-full text-center text-2xl font-semibold leading-tight text-surface-900 dark:text-surface-0"
              >
                Welcome Back
              </div>
              <div class="w-full text-center">
                <span
                  class="leading-normal text-surface-700 dark:text-surface-200"
          ...
          <div class="flex w-full flex-col gap-6">
            <div class="flex w-full flex-col gap-2">
              <label
                for="email1"
                class="font-medium leading-normal text-surface-900 dark:text-surface-0"
                >Email Address</label
              >
              <PrimeInputText
                id="email1"
            ...
            >
              <div class="flex items-center gap-2">
                <PrimeCheckbox id="rememberme1" v-model="checked1" :binary="true" />
                <label
                  for="rememberme1"
              ...
              <a
                class="cursor-pointer font-medium text-primary hover:text-primary-emphasis"
    ...
    >
      <div
        class="bg-surface-0 px-8 py-12 md:px-20 md:py-20 lg:px-80 dark:bg-surface-950"
      >
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2 pb-4">
            <div
              class="text-xl font-semibold leading-tight text-surface-900 dark:text-surface-0"
            >
              Movie Information
            </div>
            <div
          ...
          <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-4 md:flex-row">
              <div class="flex flex-1 items-center gap-4">
                <div
                  class="w-[140px] text-base font-medium leading-tight text-surface-900 dark:text-surface-0"
                >
                  Title
                </div>
                <div
                  class="flex-1 text-base leading-tight text-surface-900 dark:text-surface-0"
                >
                  Heat
                </div>
              </div>
            ...
            <div class="flex flex-col gap-4 md:flex-row">
              <div class="flex flex-1 items-center gap-4">
                ...
                <div class="flex flex-1 flex-wrap gap-2">
                  <PrimeChip label="Crime" severity="secondary" />
                  <PrimeChip label="Drama" severity="secondary" />
                  <PrimeChip label="Thriller" severity="secondary" />
                </div>
              </div>
              <div class="flex justify-end">
                <PrimeButton
            ...
            <div class="flex flex-col gap-4 md:flex-row">
              <div class="flex flex-1 items-start gap-4">
                ...
                <div
                  class="flex-1 text-base leading-normal text-surface-900 dark:text-surface-0"
                >
    ...
    <BlockViewer header="Card" :code="blocksCode.card" free>
      ...
      >
        <div
          class="flex flex-col gap-4 rounded-2xl bg-surface-0 p-6 shadow dark:bg-surface-900"
        >
          <div class="flex gap-4">
            <div class="flex flex-1 flex-col gap-2">
              <div
                class="text-2xl font-semibold leading-tight text-surface-900 dark:text-surface-0"
              >
                Card Title
              </div>
              <div
          ...
          <div class="flex flex-1">
            <div
              class="h-[150px] flex-1 rounded-lg border-2 border-dashed border-surface-200 dark:border-surface-700"
            />
          </div>
        </div>
      </div>
